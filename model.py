...
class Generator(nn.Module):
    def __init__(self, code_dim, n_classes=34, condition=2):
        super().__init__()
...
class StyledGenerator(nn.Module):
    def __init__(self, code_dim=512, n_mlp=8, n_classes=34, condition=2):
        super().__init__()
...
class Discriminator(nn.Module):
    def __init__(self, n_classes=34, condition=2):
        super().__init__()
